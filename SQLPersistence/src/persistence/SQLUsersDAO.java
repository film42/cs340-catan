...
public class SQLUsersDAO implements UsersDAO {
	 ...
	 */
	public List<persistence.UserDTO> getUsers(){

        List<persistence.UserDTO> usersDTO = new ArrayList<persistence.UserDTO>();
        ...
        try{
            ...
            while(rs.next()){
              persistence.UserDTO userDTO = new persistence.UserDTO(rs.getInt(1),
                                            rs.getString(2),
                                            rs.getString(3));
